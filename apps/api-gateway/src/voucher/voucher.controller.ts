...
export class VoucherController {
  ...
  @ApiOperation({ summary: 'Get available vouchers by phone variant IDs (require authentication)' })
  @ApiBody({
    description: 'Array of phone variant IDs',
    required: true,
    schema: {
  ...
  async getAvailableVouchersForCustomer(
    ...
    try {
      ...
      >(
        this.voucherServiceClient,
        VOUCHER_SERVICE_NAME,
        VOUCHER_PATTERN.GET_AVAILABLE_VOUCHERS_FOR_CUSTOMER,
        { requester, variantIds: body.variantIds },
        () => {
          return {
            fallback: true,
            message: 'Voucher service is temporarily unavailable',
