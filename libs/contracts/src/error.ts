...
export class AppError extends Error {
  ...
  withDetail(key: string, value: unknown): AppError {
  ...
  toJson(isProduction: boolean = true): ErrorResponse {
...
type ErrorResponse = BaseErrorResponse | DevErrorResponse;

export const respondError = (res: Response, error: Error): void => {
